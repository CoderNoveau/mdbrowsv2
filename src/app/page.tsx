...
export default function Home() {
  ...
  return (
    <>
      <PageSeo
        title="Melbourne Designer Brows | Premier Microblading & Cosmetic Tattooing"
        ...
        openGraph={{
          ...
          images: [
            {
              url: 'https://mdbrows.com.au/images/hero1.webp',
              width: 1200,
              height: 630,
              alt: 'Melbourne Designer Brows - Premium Eyebrow Services',
            },
          ],
        }}
      />
